...
std::vector<double> progn_correct(std::vector<double>  *y_n, std::vector<double> *y_n1, std::vector<double> *y_n2, std::vector<double> *y_n3, double h)
{
    ...
    tmp =  *y_n + h / 24.0 * (55.0 * func(*y_n) - 59.0 * func(*y_n1) + 37.0 * func(*y_n2) - 9.0 * func(*y_n3));
    y =  *y_n + h / 24.0 * (9.0 * func(tmp) + 19.0 * func(*y_n) - 5.0 * func(*y_n1) + func(*y_n2));
    *y_n3 = *y_n2;
    *y_n2 = *y_n1;
    *y_n1 = *y_n;
    return y;
...
{
	std::vector<double> y(dim);
	y = *y_n + h / 24.0 * (55.0 * func(*y_n) - 59.0 * func(*y_n1) + 37.0 * func(*y_n2) - 9.0 * func(*y_n3));
	*y_n3 = *y_n2;
	*y_n2 = *y_n1;
	*y_n1 = *y_n;
	return y;
